...
print(df[["Department","City"]]) #Output: Department & City columns with standardized text

# Confirm: 120 rows, zero missing values
print(df.shape)
print(df.isnull().sum())

# Finish with a groupby("Department") summary
print(df.groupby("Department")["Salary"].mean().round(1))